...
class BwController:
    ...
    def step(self, readings):
        ...
        # Which of the cycle's readings stands for the ratio it was taken at.
        ...
        # A step too small to take, from a point that reads worse than the one
        # before it, means the last step was the wrong move: undo it rather
        # than settle here.
